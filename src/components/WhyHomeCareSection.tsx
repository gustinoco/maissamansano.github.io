...
const WhyHomeCareSection = () => {
  ...
  const benefits = [
    { icon: MapPin, title: t.whyHomeCare.benefit1Title, description: t.whyHomeCare.benefit1Desc },
    { icon: Shield, title: t.whyHomeCare.benefit2Title, description: t.whyHomeCare.benefit2Desc },
    { icon: Users, title: t.whyHomeCare.benefit3Title, description: t.whyHomeCare.benefit3Desc },
    { icon: CheckCircle, title: t.whyHomeCare.benefit4Title, description: t.whyHomeCare.benefit4Desc },
  ];
